...
return {
	...
	name = _("TGV (long)"),
	desc = _("The famous French high speed train operated by the French national railway company. It is a permanently coupled electric multiple unit and was built for operation between Paris and the south-east of France.")
}
end
